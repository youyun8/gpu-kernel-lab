...
export function SiteFooter() {
  return (
    <footer className="border-t border-border bg-card/40">
      <AppWidthContainer className="px-4 py-8 text-sm text-muted-foreground">
        <p className="text-muted-foreground">{kSiteConfig.name}</p>
        <p className="mt-1">
        ...
        <p className="mt-3 text-xs text-muted-foreground">環境需求: {kSiteConfig.requirements}。以 MIT License 釋出。</p>
      </AppWidthContainer>
    </footer>
  );
}
